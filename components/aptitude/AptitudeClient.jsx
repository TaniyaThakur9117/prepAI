...
//     // adaptive difficulty logic: if last two were correct -> increase, if last two wrong -> decrease
...
//     });
//     // show result or redirect to report
...
//         <button onClick={finish} className="mt-4 bg-blue-600 text-white px-4 py-2 rounded">
//           Submit & Save
//         </button>
//       </div>
//     );
...
//   const opts = q.options; // stored as JSONB
//   return (
//     <div>
//       <div className="mb-3 text-lg font-semibold">Q{index + 1}: {q.question}</div>
...
//         ))}
//       </div>
//       <div className="mt-4 text-sm text-gray-600">Difficulty: {difficulty}</div>
//     </div>
//   );
// }
